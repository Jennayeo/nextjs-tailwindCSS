    ...
    return (
        <>
           <header className="text-gray-600 body-font fixed p-10 w-[100%] h-[100px]">
                    ...
                    <Link href="/main">
                        <button className="inline-flex items-center py-1 px-3">
                ...
                <button className="inline-flex items-center border-0 py-1 px-3 focus:outline-none rounded text-base mt-4 md:mt-0 float-right "
                        type="button"
                ...
                >
                 ...
                 <button className="inline-flex items-center border-0 py-1 px-3 focus:outline-none rounded text-base mt-4 md:mt-0 float-right "
                    type="button"
                    onClick={() => props.setEnglish(!props.english)}
                >
                    <div className='flex'>
